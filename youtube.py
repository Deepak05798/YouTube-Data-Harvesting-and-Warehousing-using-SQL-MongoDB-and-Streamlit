...
with st.sidebar:
    selected = option_menu(None, ["Home","Extract-migrate & Transfer","Analyze Zone"], 
...
def get_comments_details(v_id):
    ...
    try:
        ...
        while comment_count < 100:  # Limit to 100 comments
            ...
            if next_page_token is None or comment_count >= 100:
                break
...
# Column 2
 col2.markdown("#   \n#   \n#   ")
 col2.image("C:\\Users\\deepa\\Downloads\\youtube.png")
    ...
    with tab1:
        ...
        if st.button("Migrate to MongoDB"):
            with st.spinner('Please Wait'):
                logging.info("migrate data to MongoDB")
                ch_details = get_channel_details(ch_id)
